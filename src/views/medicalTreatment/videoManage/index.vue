<template>
  <el-container>
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" @sort-change="handleSort" element-loading-text="给我一点时间" border highlight-current-row stripe @selection-change="chioceList" >
      ...
      <el-table-column label="资源名称" prop="name" min-width="160" align="center" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column label="售价" prop="realPrice" min-width="180" align="center" ></el-table-column>
      <el-table-column label="创建时间" min-width="180" align="center" prop="uploadTime" sortable="custom"></el-table-column>
      <el-table-column label="时长" prop="timeLength" min-width="180" align="center" ></el-table-column>
      <el-table-column label="文件大小" prop="size" min-width="180" align="center"></el-table-column>
